...
class KavaZdarama extends StatelessWidget {
  const KavaZdarama({Key? key}) : super(key: key);
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Image.asset(AppImages.coffeeCupFilled),
                          ...
                          Column(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              Image.asset(AppImages.coffeeCupTransparent),
